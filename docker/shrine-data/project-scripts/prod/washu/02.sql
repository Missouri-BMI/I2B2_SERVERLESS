...
use schema i2b2pm;
insert into PM_USER_DATA (user_id, full_name, password, status_cd) values ('mhmcb@umsystem.edu', 'Md Saber Hossain', '0e4d24745153c411aa72bf966495dc4', 'A');
INSERT INTO PM_PROJECT_USER_ROLES (PROJECT_ID, USER_ID, USER_ROLE_CD, STATUS_CD) VALUES('@', 'mhmcb@umsystem.edu', 'ADMIN', 'A');
insert into PM_PROJECT_USER_ROLES (PROJECT_ID, USER_ID, USER_ROLE_CD, STATUS_CD) values ('ACT', 'mhmcb@umsystem.edu', 'USER', 'A');
INSERT INTO PM_PROJECT_USER_ROLES (PROJECT_ID, USER_ID, USER_ROLE_CD, STATUS_CD) VALUES('ACT', 'mhmcb@umsystem.edu', 'MANAGER', 'A');
...
VALUES('AGG_SERVICE_ACCOUNT', 'AGG_SERVICE_ACCOUNT', '0e4d24745153c411aa72bf966495dc4', 'A');
...
insert into PM_USER_DATA (user_id, full_name, password, status_cd) values ('shrine', 'SHRINE User', '0e4d24745153c411aa72bf966495dc4', 'A');
...
insert into PM_USER_DATA (user_id, full_name, password, status_cd) values ('shrine_steward', 'SHRINE Data Steward User', '0e4d24745153c411aa72bf966495dc4', 'A');
...
insert into PM_USER_PARAMS (DATATYPE_CD, USER_ID, PARAM_NAME_CD, VALUE, CHANGEBY_CHAR, STATUS_CD) values ('T', 'shrine_steward', 'DataSteward', 'true', 'mhmcb@umsystem.edu', 'A');
